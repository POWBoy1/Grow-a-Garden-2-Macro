...
set "newfolder=%parentfolder%\Epics_GAG2_macro_v%ver%"
...
set "zipfile=%temp%\Epics_GAG2_macro_v%ver%.zip"
...
:: Start Macro
echo Starting Macro...
start "" "%newfolder%\scripts\AutoHotkey32.exe" "%newfolder%\scripts\Epic's_GAG2_macro.ahk"
